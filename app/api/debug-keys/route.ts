...
export async function GET(req: NextRequest) {
	...
	const insertTest = { success: false, error: null as any };
	try {
	...
	const keyMatchesExpected =
		serviceRoleKey?.startsWith(expectedPrefix) || false;
	...
	return NextResponse.json({
		...
		comparison: {
			...
			criticalIssue: keysMatch
				? "CRITICAL: Keys are identical! Service role key must be different from anon key."
				: null,
		},
		insertTest,
