...
export default function BillingDashboard({ userId }: BillingDashboardProps) {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="bg-[#151519] border border-[#374151] rounded-2xl p-8 shadow-lg">
        <h2 className="text-[#F8F9FA] font-bold text-2xl mb-6">Subscription Management</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 border border-[#374151] rounded-xl bg-[#1F1F23] hover:bg-[#262626] transition-all duration-300">
              <h4 className="font-bold text-[#F8F9FA] text-lg mb-2">Basic</h4>
              <p className="text-sm text-[#9CA3AF] mb-4">Up to 50 job matches per month</p>
              <button
                className="btn-secondary w-full"
                onClick={() => handleSubscriptionAction('upgrade', 'basic')}
            ...
            <div className="p-6 border border-[#374151] rounded-xl bg-[#1F1F23] hover:bg-[#262626] transition-all duration-300">
              <h4 className="font-bold text-[#F8F9FA] text-lg mb-2">Professional</h4>
              <p className="text-sm text-[#9CA3AF] mb-4">Unlimited job matches with advanced features</p>
              <button
                className="btn-secondary w-full"
            ...
            <div className="p-6 border border-[#374151] rounded-xl bg-[#1F1F23] hover:bg-[#262626] transition-all duration-300">
              <h4 className="font-bold text-[#F8F9FA] text-lg mb-2">Enterprise</h4>
              <p className="text-sm text-[#9CA3AF] mb-4">Everything in Pro plus dedicated support</p>
              <button
                className="btn-secondary w-full"
