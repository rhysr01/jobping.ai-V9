			...
			>
				...
				<form onSubmit={handleSubmit} className="space-y-6">
					<div>
						<label
							htmlFor="email"
							className="block text-small font-medium text-neutral-300 mb-2"
						>
							Email Address
						</label>
						<input
						...
						{emailError && (
							<div
								className="mt-2 p-3 rounded-lg surface-error"
								role="status"
								aria-live="polite"
							>
					...
					<div className="surface-raised rounded-xl p-4">
						<h3 className="text-small font-medium text-neutral-300 mb-2">
							What you'll get:
						</h3>
