      ...
      <div className="container-page py-16 md:py-24">
        <div className="mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-semibold text-white mb-4">Pricing</h1>
            <p className="text-xl text-zinc-300">{Copy.PRICING_TITLE}</p>
            <p className="text-base text-zinc-400 mt-2">{Copy.PRICING_SUBTITLE}</p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 mb-12">
            ...
            <div className="rounded-xl bg-white/[0.06] border border-white/10 backdrop-blur-xl shadow-pricing px-6 py-8">
              <div className="mb-6">
                <p className="text-xs uppercase tracking-wider text-zinc-300 mb-2">{Copy.FREE_PLAN_TITLE}</p>
                <div className="flex items-baseline gap-2 mb-4">
                  <span className="text-4xl font-semibold text-white">€0</span>
                  <span className="text-base text-zinc-300">forever</span>
                </div>
                <h3 className="text-xl font-semibold text-white mb-2">Kickstart in under 2 minutes</h3>
                <p className="text-base text-zinc-300/90">{Copy.FREE_PLAN_DESCRIPTION}</p>
              </div>
            ...
            <div className="relative rounded-xl bg-zinc-900 border border-violet-500/60 shadow-[0_24px_60px_rgba(129,140,248,0.35)] px-6 py-8 md:scale-[1.02] md:-translate-y-1">
              ...
              <div className="mb-6">
                <p className="text-xs uppercase tracking-wider text-zinc-300 mb-2">{Copy.PREMIUM_PLAN_TITLE}</p>
                <div className="flex items-baseline gap-2 mb-4">
                  <span className="text-4xl font-semibold text-white">{Copy.PREMIUM_PLAN_PRICE}</span>
                  <span className="text-base text-zinc-300">{Copy.PREMIUM_PLAN_PRICE_UNIT}</span>
                </div>
                <h3 className="text-xl font-semibold text-white mb-2">Stay ahead of every opening</h3>
                <p className="text-base text-zinc-300/90">{Copy.PREMIUM_PLAN_DESCRIPTION}</p>
              </div>
