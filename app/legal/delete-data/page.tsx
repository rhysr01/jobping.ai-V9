  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(
          result.error || "Failed to delete data. Please contact support.",
        );
      }
    } catch (_err) {
      setError(
        "An error occurred. Please try again or contact privacy@getjobping.com",
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 md:px-8">
        <div className="bg-white/5 rounded-2xl p-8 border border-white/10 shadow-lg">
          ...
          <p className="text-zinc-300 mb-8">
            We respect your privacy. Enter your email address below to
            permanently delete all your data from JobPing.
          </p>

          <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg mb-8">
            <p className="text-sm text-red-300">
              <strong className="text-red-200"> Warning:</strong> This action
              cannot be undone. All your preferences, matches, and account data
          ...
          <div className="mt-8 pt-8 border-t border-white/10">
            ...
            <p className="text-xs text-zinc-400 mt-6">
              ...
              <a
                href="mailto:privacy@getjobping.com"
