							...
							<div className="space-y-4">
								<div>
									...
									<ul className="list-disc pl-6 mb-4 text-zinc-300 space-y-1">
										...
										<li>
											We do not send welcome emails, newsletters, or job alerts
											to free tier users
										</li>
										<li>Your email is only used for account identification</li>
										<li>
											Your data is automatically deleted after 30 days of
											inactivity
										</li>
									</ul>
								</div>
								<div>
									...
									<ul className="list-disc pl-6 mb-4 text-zinc-300 space-y-1">
										<li>
											You will receive job match emails 3 times per week
											(Monday, Wednesday, Friday at 9 AM GMT)
										</li>
										<li>
											Welcome email with 10 job matches immediately upon signup
										</li>
										<li>
											You can unsubscribe or pause emails anytime from email
											footer or account settings
										</li>
										<li>
											Your data is retained as long as your subscription is
											active
										</li>
									</ul>
								</div>
							...
							<div className="space-y-4">
								<div>
									<p className="text-zinc-300 mb-2">
										<strong className="text-white">Free Tier:</strong> Your
										account data (email, preferences, matches) is automatically
										deleted 30 days after signup if you don't upgrade to
										Premium.
									</p>
								</div>
								<div>
									<p className="text-zinc-300 mb-2">
										<strong className="text-white">Premium Tier:</strong> Your
										data is retained for as long as your subscription is active,
										plus 30 days after cancellation for billing purposes.
									</p>
								</div>
