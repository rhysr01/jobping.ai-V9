      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8">
        <div className="bg-white/5 rounded-2xl p-8 border border-white/10 shadow-lg">
          ...
          <div className="space-y-8">
            <section>
              <h2 className="text-xl md:text-2xl font-semibold text-white mt-8 mb-4 tracking-tight">1. Service Tiers</h2>
              <div className="space-y-6">
                <div>
                  ...
                  <ul className="list-disc pl-6 mb-4 text-zinc-300 space-y-2">
                    ...
                    <li>Account and data automatically deleted after 30 days</li>
                    <li>Cannot sign up for free tier more than once per email address</li>
                  </ul>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-white mb-3">Premium Tier (€5/month):</h3>
                  <ul className="list-disc pl-6 mb-4 text-zinc-300 space-y-2">
                    <li>10 instant job matches on signup</li>
                    <li>5 fresh job matches delivered via email 3x per week (Monday, Wednesday, Friday)</li>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-semibold text-white mt-8 mb-4 tracking-tight">2. Acceptance of Terms</h2>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-semibold text-white mt-8 mb-4 tracking-tight">3. Description of Service</h2>
              <p className="text-zinc-300 mb-6">
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-semibold text-white mt-8 mb-4 tracking-tight">4. User Accounts</h2>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-semibold text-white mt-8 mb-4 tracking-tight">5. Acceptable Use</h2>
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-semibold text-white mt-8 mb-4 tracking-tight">6. Privacy</h2>
              <p className="text-zinc-300 mb-6">
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-semibold text-white mt-8 mb-4 tracking-tight">7. Intellectual Property</h2>
              <p className="text-zinc-300 mb-6">
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-semibold text-white mt-8 mb-4 tracking-tight">8. Termination</h2>
              <p className="text-zinc-300 mb-6">
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-semibold text-white mt-8 mb-4 tracking-tight">9. Limitation of Liability</h2>
              <p className="text-zinc-300 mb-6">
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-semibold text-white mt-8 mb-4 tracking-tight">10. Changes to Terms</h2>
              <p className="text-zinc-300 mb-6">
            ...
            <section>
              <h2 className="text-xl md:text-2xl font-semibold text-white mt-8 mb-4 tracking-tight">11. Governing Law</h2>
              <p className="text-zinc-300 mb-6">
