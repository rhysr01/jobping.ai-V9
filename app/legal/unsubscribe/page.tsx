        ...
        <div className="bg-glass-default border border-border-default shadow-lg rounded-lg p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-white/80 mb-6">
              We respect your privacy and give you control over the emails you
              receive from JobPing.
            </p>
            ...
            <div className="bg-glass-subtle border-l-4 border-border-elevated p-4 mb-6 border border-border-subtle">
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-white/80">
                    <strong>Important:</strong> Unsubscribing from all emails
                    will prevent you from receiving job recommendations and
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Important updates about JobPing features and policies
                    </p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-700 mb-4">
                  Use the toggles above to unsubscribe from specific email
                  categories while keeping others active.
                </p>
              </div>
            </div>
            ...
            <p className="text-gray-700 mb-6">
              If you change your mind, you can always resubscribe to our emails
              by:
            </p>
            ...
            <div className="bg-blue-50 p-6 rounded-lg mt-8">
              ...
              <p className="text-gray-700 mb-4">
                If you have questions about unsubscribing or need help managing
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <p className="text-sm text-gray-600">
                <strong>Note:</strong> Processing unsubscribe requests may take
                up to 48 hours. You may still receive emails during this period.
              </p>
            </div>
          </div>
        </div>
