      ...
      <div className="container-page max-w-3xl text-center px-6 sm:px-8">
        ...
        >
          ...
          <div className="rounded-3xl border-2 border-white/20 bg-white/[0.08] p-8 sm:p-10 md:p-12 text-left backdrop-blur-md shadow-[0_24px_80px_rgba(0,0,0,0.5)]">
            <h2 className="text-2xl font-bold text-white mb-8 text-center sm:text-3xl">What Happens Next?</h2>
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              >
                ...
                <div className="flex-1">
                  <div className="font-bold text-white text-lg sm:text-xl mb-2">Review & apply</div>
                  <div className="text-zinc-100 text-sm sm:text-base font-medium leading-relaxed">Each email takes under a minute to scan and links straight to the application.</div>
                </div>
              </motion.div>
          ...
          <p className="mt-10 text-sm font-medium text-zinc-300">
            Still nothing? Tap resend above or email <a href="mailto:hello@getjobping.com" className="text-brand-200 hover:text-brand-100 underline">hello@getjobping.com</a>.
          </p>
        </motion.div>
      </div>
    </div>
