...
async function main() {
	...
	const SEARCHES = [
		...
		// Finance
		{
			city: "London",
			country: "united kingdom",
			category: "Finance Intern",
			terms: ["finance internship", "investment intern", "banking intern"],
		},
		{
			city: "Dublin",
			country: "ireland",
			category: "Finance Intern",
			terms: ["finance internship", "accounting intern"],
		},
		{
			city: "Paris",
			country: "france",
			category: "Finance Intern",
			terms: ["stage finance", "stage banque"],
		},
		{
			city: "Frankfurt",
			country: "germany",
			category: "Finance Intern",
			terms: ["praktikum finance", "praktikum banking"],
		},
		...
		// Consulting
		{
			city: "London",
			country: "united kingdom",
			category: "Consulting Intern",
			terms: ["consulting internship", "strategy intern"],
		},
		{
			city: "Dublin",
			country: "ireland",
			category: "Consulting Intern",
			terms: ["consulting internship", "management consulting intern"],
		},
		{
			city: "Paris",
			country: "france",
			category: "Consulting Intern",
			terms: ["stage consulting", "stage stratégie"],
		},
		{
			city: "Madrid",
			country: "spain",
			category: "Consulting Intern",
			terms: ["prácticas consultoría", "prácticas estrategia"],
		},
		...
		// Marketing
		{
			...
			terms: ["marketing internship", "digital marketing intern"],
		},
		{
			city: "Amsterdam",
			country: "netherlands",
			category: "Marketing Intern",
			terms: ["marketing stage", "digital marketing intern"],
		},
		{
			city: "Berlin",
			country: "germany",
			category: "Marketing Intern",
			terms: ["marketing praktikum", "digital marketing praktikum"],
		},
		{
			city: "Barcelona",
			country: "spain",
			category: "Marketing Intern",
			terms: ["prácticas marketing", "prácticas marketing digital"],
		},
		...
		// Tech/Product
		{
			city: "London",
			country: "united kingdom",
			category: "Tech Intern",
			terms: ["product intern", "software intern"],
		},
		{
			city: "Berlin",
			country: "germany",
			category: "Tech Intern",
			terms: ["product management praktikum", "software praktikum"],
		},
		{
			city: "Amsterdam",
			country: "netherlands",
			category: "Tech Intern",
			terms: ["product intern", "tech intern"],
		},
		...
		// Operations
		{
			...
			terms: ["operations internship", "supply chain intern"],
		},
		{
			city: "Dublin",
			country: "ireland",
			category: "Operations Intern",
			terms: ["operations internship", "project management intern"],
		},
		{
			city: "Paris",
			country: "france",
			category: "Operations Intern",
			terms: ["stage operations", "stage supply chain"],
		},
	];
...
`,
	...
	console.log(
		`   Career Internships: Finance, Consulting, Marketing, Tech, Operations`,
	);
