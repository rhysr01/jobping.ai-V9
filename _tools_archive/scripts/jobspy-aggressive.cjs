...
async function main() {
	...
	const SEARCHES = [
		...
		// DUBLIN
		{
			city: "Dublin",
			country: "ireland",
			terms: ["finance graduate", "consulting graduate", "business analyst"],
		},
		// MADRID
		{
			city: "Madrid",
			country: "spain",
			terms: ["prácticas finance", "prácticas consultoría", "analista junior"],
		},
		// BERLIN
		{
			city: "Berlin",
			country: "germany",
			terms: ["praktikum finance", "junior analyst", "trainee consulting"],
		},
		// PARIS
		{
			city: "Paris",
			country: "france",
			terms: ["stage finance", "stage consulting", "analyste junior"],
		},
		// AMSTERDAM
		{
			city: "Amsterdam",
			country: "netherlands",
			terms: ["finance trainee", "junior analyst", "stage finance"],
		},
		// ZURICH
		{
			city: "Zurich",
			country: "switzerland",
			terms: ["praktikum finance", "junior analyst", "trainee"],
		},
	];
