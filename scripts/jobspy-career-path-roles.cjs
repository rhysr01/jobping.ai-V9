...
function getAllRoles() {
  const CAREER_PATHS = [
    ...
    { 
      value: 'retail-luxury', 
      roles: ['Retail Buyer', 'Merchandising Assistant', 'Luxury Retail Associate', 'Fashion Assistant', 'Retail Operations Analyst', 'Visual Merchandiser', 'Luxury Brand Assistant', 'Retail Management Trainee', 'Buying Assistant', 'Fashion Merchandising Intern', 'Luxury Sales Associate', 'Retail Planning Analyst', 'Fashion Retail Graduate', 'Luxury Client Advisor', 'Retail Marketing Assistant']
    },
    { 
      value: 'sales', 
    ...
    { 
      ...
      roles: ['Startup Intern', 'Venture Capital Analyst', 'Innovation Intern', 'Entrepreneurship Programme', 'Startup Operations Assistant', 'Business Development Intern (Startup)', 'Product Manager (Startup)', 'Growth Hacker', 'Founder Associate', 'Startup Analyst', 'Venture Analyst', 'Innovation Analyst', 'Early Stage Associate', 'Startup Coordinator', 'Entrepreneurship Fellow']
    },
    { 
      value: 'unsure', 
