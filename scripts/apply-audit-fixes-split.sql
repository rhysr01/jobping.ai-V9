-- ============================================================================
-- APPLY DATA QUALITY AUDIT FIXES (SPLIT VERSION)
-- ============================================================================
-- This script is split into two parts:
-- PART 1: Index creation (must run OUTSIDE transaction)
-- PART 2: Data fixes (run INSIDE transaction)
-- ============================================================================

-- ============================================================================
-- PART 1: CREATE INDEX (run this FIRST, outside any transaction)
-- ============================================================================
-- CRITICAL: CREATE INDEX CONCURRENTLY cannot run inside a transaction block
-- Run this part separately, then run PART 2
...
-- ============================================================================
-- PART 2: DATA FIXES (run this AFTER PART 1, inside transaction)
-- ============================================================================
...
-- ============================================================================
-- VERIFICATION QUERIES (run after both parts)
-- ============================================================================
