...
// Real-world company names that are more likely to exist
const realWorldCompanies = [
  // European tech companies (more likely to use Lever)
...
async function discoverRealWorldCompanies() {
  console.log('🎯 Discovering Real-World Lever Companies');
  console.log('========================================\n');
  ...
  const newCompanies = realWorldCompanies.filter(company => !existingCompanies.includes(company));
...
discoverRealWorldCompanies().catch(console.error);
