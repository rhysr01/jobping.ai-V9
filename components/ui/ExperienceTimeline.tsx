...
const EXPERIENCE_LEVELS: ExperienceOption[] = [
	{
		...
		description: "New to the field - learning fast.",
	},
	{
		value: "6 months",
		label: "6 months",
		...
		description: "Early hands-on experience.",
	},
	{
		value: "1 year",
		label: "1 year",
		months: 12,
		Icon: BrandIcons.Star,
	...
	},
	{
		...
		description: "Growing and ready for more.",
	},
	{
		value: "2 years",
		label: "2 years",
		...
		description: "Confident contributor.",
	},
	{
		value: "3+ years",
		label: "3+ years",
		...
		description: "Seasoned early-career pro.",
	},
];
...
export default function ExperienceTimeline({
	...
	const selectedIndex = EXPERIENCE_LEVELS.findIndex(
		(exp) => exp.value === selected,
	);
	const maxMonths = Math.max(...EXPERIENCE_LEVELS.map((e) => e.months));
	const selectedLevel =
		selectedIndex >= 0 ? EXPERIENCE_LEVELS[selectedIndex] : null;
				...
				<div className="h-2 bg-zinc-800 rounded-full overflow-hidden">
					...
					{selectedIndex >= 0 && (
						<motion.div
							initial={{ width: 0 }}
							animate={{
								width: `${(EXPERIENCE_LEVELS[selectedIndex].months / maxMonths) * 100}%`,
							}}
