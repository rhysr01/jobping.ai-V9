...
export default function ExampleMatchesModal({
	isOpen,
	onClose,
}: ExampleMatchesModalProps) {
				...
				>
					...
					>
						...
						<div className="text-center mb-6 md:mb-8">
							<h2
								id="example-matches-title"
								className="text-2xl md:text-3xl font-bold text-white mb-2"
							>
								See What You'll Get
							</h2>
							<p className="text-sm md:text-base text-zinc-400">
								Here's what your job matches look like - personalized to your
								preferences
							</p>
						</div>
