        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center mt-4 md:mt-8 overflow-visible">
          ...
          >
            ...
            >
              ...
              <span className="text-content-primary block">instantly</span>
              <GradientText
                variant="brand"
                className="text-[3rem] leading-[1.1] sm:text-6xl md:text-7xl font-black"
              >
                free
              </GradientText>
            </motion.h1>
            ...
            >
              Stop guessing about{" "}
              <strong className="text-white font-bold">visa status</strong>. Get
              curated graduate roles{" "}
              <strong className="text-white font-bold">
                matched to your city and career path
              </strong>{" "}
              in under 2 minutes.
            </motion.p>
