...
export default function HowItWorksWithShowcase() {
    ...
    >
      ...
      <div className="container-page relative z-10">
        ...
        <motion.div
          ...
          className="mx-auto max-w-5xl text-left sm:text-center mb-16"
        >
        ...
        {/* Split Layout: iPhone Showcase Left, How It Works Steps Right */}
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-7xl mx-auto">
          {/* LEFT SIDE: iPhone Showcase */}
          <motion.div
