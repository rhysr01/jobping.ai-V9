		...
		>
			...
			<div className="container-page relative z-10">
				...
				>
					...
					<h2 className="section-title mt-4 mb-2">How JobPing Works</h2>
				...
				<div className="relative mt-14 grid gap-8 sm:mt-16 grid-cols-1 md:grid-cols-3 max-w-5xl mx-auto">
					...
					{Copy.HOW_IT_WORKS_STEPS.filter((step) => step?.title).map(
						(step, index) => {
								...
								>
									...
									<div className="relative z-10">
										...
										<div className="flex items-start gap-3 mb-3">
											...
											<h3 className="text-xl font-semibold text-zinc-100 sm:text-2xl tracking-tight leading-tight">
												{step.title}
											</h3>
										</div>
