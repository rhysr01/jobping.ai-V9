      ...
      <div className="container-page relative z-10">
        ...
        >
          ...
          <p className="text-zinc-400 text-base sm:text-lg md:text-xl">
            ...
            <span className="text-white font-bold">15 hours/week</span>{" "}
            searching.
            <br />
                ...
                <TiltCard>
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      {/* Icon */}
                      <div
                        className={`inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-2xl mb-4 sm:mb-6 ${
                          tier.popular
                      ...
                      >
                        <Icon
                          size={20}
                          className={`sm:w-6 sm:h-6 ${tier.popular ? "text-white" : "text-zinc-400"}`}
                        />
                      </div>
