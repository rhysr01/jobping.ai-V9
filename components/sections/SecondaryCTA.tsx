    ...
    <section className="pt-16 pb-16 md:pt-20 md:pb-20 lg:pt-24 lg:pb-24 scroll-snap-section relative">
      ...
      <div className="container-page relative z-10">
        <motion.div
          ...
          className="relative overflow-hidden rounded-xl bg-white/[0.05] border border-white/10 shadow-[0_4px_20px_rgba(0,0,0,0.35)] backdrop-blur-xl px-6 py-10 md:px-10 md:py-12 max-w-5xl mx-auto text-center hover:-translate-y-1 transition-all duration-200"
        >
