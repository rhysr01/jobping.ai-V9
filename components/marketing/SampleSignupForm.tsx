			...
			<div className="space-y-6">
				...
				<div className="rounded-xl border-2 border-white/20 p-4 shadow-[0_15px_50px_rgba(0,0,0,0.5)] backdrop-blur-xl bg-white/[0.03]">
					<div className="space-y-5">
							...
							<label className="flex items-start gap-2 cursor-pointer">
								...
								<div className="flex-1">
									...
									<p className="text-[10px] text-zinc-400">
										...
										<span className="text-brand-400 underline font-semibold">
											Privacy Policy
										</span>{" "}
										and{" "}
										<span className="text-brand-400 underline font-semibold">
						...
						{/* Full Name */}
						<div>
							<label className="block text-[12px] font-bold text-white mb-1.5">
								Full Name *
							</label>
							<input
								type="text"
						...
						<div>
							...
							<p className="text-[10px] font-medium text-zinc-300 mb-2">
						...
						<div>
							...
							<div className="flex flex-wrap gap-2 mt-2">
								{["London", "Dublin", "Amsterdam"].map((city) => (
									<span
										key={city}
										className="px-3 py-1.5 bg-brand-500/20 border border-brand-500/40 rounded-lg text-[11px] font-medium text-brand-200"
									>
										{city}
									</span>
								))}
							...
							<p className="mt-1.5 text-[10px] text-green-400 flex items-center gap-1.5 font-medium">
								<BrandIcons.CheckCircle className="h-3 w-3 flex-shrink-0" />3
								cities selected
							</p>
						</div>
						...
						<div>
							...
							<p className="mt-1.5 text-[10px] text-green-400 flex items-center gap-1.5 font-medium">
								<BrandIcons.CheckCircle className="h-3 w-3 flex-shrink-0" />2
								languages selected
							</p>
						</div>
					</div>
				...
				<div className="rounded-xl border-2 border-white/20 p-4 shadow-[0_15px_50px_rgba(0,0,0,0.5)] backdrop-blur-xl bg-white/[0.03]">
					<div className="space-y-5">
						...
						{/* Submit Button */}
						<button className="w-full bg-gradient-to-r from-brand-500 to-brand-600 text-white font-semibold py-3 rounded-xl text-[13px] shadow-[0_4px_16px_rgba(109,90,143,0.3)] flex items-center justify-center gap-2 mt-2">
							Complete Signup
							<BrandIcons.Check className="h-4 w-4" />
						</button>
					</div>
