...
-- ============================================================================
-- 3. CLEAN EXISTING COMPANY NAMES (Remove legal suffixes)
-- Uses your cleanCompany() function logic
-- ============================================================================

UPDATE jobs
SET company = REGEXP_REPLACE(company, '\s+(Ltd\.?|Limited|Inc\.?|Incorporated|GmbH|S\.A\.?|S\.L\.?|S\.R\.L\.?|LLC|LLP|PLC|Corp\.?|Corporation|Co\.?|Company|AG|BV|NV|AB|Oy|AS)$', '', 'i')
WHERE company IS NOT NULL;

UPDATE jobs
SET company_name = REGEXP_REPLACE(company_name, '\s+(Ltd\.?|Limited|Inc\.?|Incorporated|GmbH|S\.A\.?|S\.L\.?|S\.R\.L\.?|LLC|LLP|PLC|Corp\.?|Corporation|Co\.?|Company|AG|BV|NV|AB|Oy|AS)$', '', 'i')
