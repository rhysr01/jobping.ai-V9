...
import { POST, GET } from '@/app/api/feedback/email/route';
...
describe('Feedback Email API Route', () => {
  ...
  describe('POST /api/feedback/email', () => {
    ...
    it('should record negative feedback', async () => {
      mockRequest.url = 'https://example.com/api/feedback/email?action=negative&score=2&email=user@example.com';
    ...
    it('should record neutral feedback', async () => {
      mockRequest.url = 'https://example.com/api/feedback/email?action=neutral&score=3&email=user@example.com';
    ...
    it('should require action parameter', async () => {
      mockRequest.url = 'https://example.com/api/feedback/email?score=5&email=user@example.com';
    ...
    it('should require email parameter', async () => {
      mockRequest.url = 'https://example.com/api/feedback/email?action=positive&score=5';
    ...
    it('should validate action values', async () => {
      mockRequest.url = 'https://example.com/api/feedback/email?action=invalid&score=5&email=user@example.com';
    ...
    it('should validate score range', async () => {
      mockRequest.url = 'https://example.com/api/feedback/email?action=positive&score=10&email=user@example.com';
  ...
  describe('GET /api/feedback/email', () => {
    beforeEach(() => {
      ...
      mockRequest.url = 'https://example.com/api/feedback/email?email=user@example.com';
    });
