...
import { POST, GET } from '@/app/api/send-re-engagement/route';
...
describe('Send Re-Engagement API Route', () => {
  ...
  beforeEach(() => {
    ...
    const { sendReEngagementEmails, getReEngagementStats } = require('@/Utils/email/reEngagementService');
  ...
  describe('POST /api/send-re-engagement', () => {
    ...
    it('should handle errors', async () => {
      const { sendReEngagementEmails } = require('@/Utils/email/reEngagementService');
  ...
  describe('GET /api/send-re-engagement', () => {
    ...
    it('should handle stats errors', async () => {
      const { getReEngagementStats } = require('@/Utils/email/reEngagementService');
