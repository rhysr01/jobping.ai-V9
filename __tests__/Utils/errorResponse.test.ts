...
describe('errorResponse', () => {
  ...
  describe('errorJson', () => {
    it('should create error response with all fields', async () => {
      const req = createMockRequest();
      const res = errorJson(req, ERROR_CODES.VALIDATION_ERROR, 'Test error', HTTP_STATUS.BAD_REQUEST, { field: 'test' });
  ...
  describe('errorResponse.badRequest', () => {
    it('should create bad request response', async () => {
      const req = createMockRequest();
      const res = errorResponse.badRequest(req, 'Invalid input', { field: 'email' });
  ...
  describe('errorResponse.internal', () => {
    it('should create internal error response', async () => {
      const req = createMockRequest();
      const res = errorResponse.internal(req, 'Server error', { stack: 'trace' });
