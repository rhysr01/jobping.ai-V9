...
import { EmbeddingService, embeddingService } from '@/Utils/matching/embedding.service';
...
describe('EmbeddingService', () => {
  ...
  describe('getUserEmbeddingWithCache', () => {
    it('should return cached embedding when available', async () => {
      ...
      const embedding = await service.getUserEmbeddingWithCache('user@example.com', userPrefs);
