...
describe("Response Optimizer", () => {
	...
	describe("createErrorResponse", () => {
		...
		it("should include details when provided", () => {
			...
			const response = optimizer.createErrorResponse("Validation failed", 422, details);
	...
	describe("Cache Management", () => {
		it("should clear all cache when no tag provided", () => {
			...
			optimizer.createOptimizedResponse({ test: "data1" }, { enableCaching: true });
			optimizer.createOptimizedResponse({ test: "data2" }, { enableCaching: true });
	...
	describe("Performance Headers", () => {
		...
		it("should accurately report response size", () => {
			...
			const smallSize = parseInt(smallResponse.headers.get("X-Response-Size") || "0");
			const largeSize = parseInt(largeResponse.headers.get("X-Response-Size") || "0");
