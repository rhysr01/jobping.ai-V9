...
describe("CV Parser Service", () => {
  ...
  describe("generateWOWInsights", () => {
    ...
    it("should highlight big tech companies", () => {
      ...
      expect(insights.some((i) => i.toLowerCase().includes("google"))).toBe(
        true,
      );
    });
    ...
    it("should identify full-stack developers", () => {
      ...
      expect(insights.some((i) => i.toLowerCase().includes("full-stack"))).toBe(
        true,
      );
    });
    ...
    it("should identify recent graduates", () => {
      ...
      expect(
        insights.some((i) => i.toLowerCase().includes("recent grad")),
      ).toBe(true);
    });
  });
