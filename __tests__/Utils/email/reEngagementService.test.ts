...
import { getReEngagementCandidates, markReEngagementSent } from '@/Utils/engagementTracker';
...
jest.mock('@/Utils/url-helpers', () => ({
  getUnsubscribeUrl: jest.fn((email) => `https://jobping.com/unsubscribe?email=${email}`)
}));
