...
describe('Subject Builder - Extended Tests', () => {
  describe('buildPersonalizedSubject - Variant A', () => {
    it('should create company list variant for multiple jobs with role and location', () => {
      const jobs = [
        { title: 'Frontend Developer', company: 'Adyen', location: 'Amsterdam', match_score: 90 },
        { title: 'React Developer', company: 'Spotify', location: 'Amsterdam', match_score: 85 },
        { title: 'UI Developer', company: 'Booking.com', location: 'Amsterdam', match_score: 80 }
      ];
      const preferences = {
    ...
    it('should handle two companies correctly', () => {
      const jobs = [
        { title: 'Backend Developer', company: 'Company A', location: 'Berlin', match_score: 90 },
        { title: 'API Developer', company: 'Company B', location: 'Berlin', match_score: 85 }
      ];
      const preferences = {
    ...
    it('should handle single company correctly', () => {
      const jobs = [
        { title: 'Data Scientist', company: 'Data Corp', location: 'London', match_score: 95 }
      ];
      const preferences = {
      ...
      expect(subject).toContain('London Data Scientist: Data Scientist at Data Corp (95% match)');
    });
  });
  ...
  describe('buildPersonalizedSubject - Variant B', () => {
    it('should create top job variant with score and company', () => {
      const jobs = [
        { title: 'React Developer', company: 'Stripe', location: 'Amsterdam', match_score: 94 },
        { title: 'Vue Developer', company: 'Other Corp', location: 'Amsterdam', match_score: 80 }
      ];
      const preferences = {
        rolePreference: 'Frontend',
        locationPreference: 'Amsterdam'
    ...
    it('should handle single job without "more" text', () => {
      const jobs = [
        { title: 'Python Developer', company: 'Tech Corp', location: 'Berlin', match_score: 88 }
      ];
      const preferences = {
      ...
      expect(subject).toContain('Berlin Python: Python Developer at Tech Corp (88% match)');
      expect(subject).not.toContain('more');
    });

    it('should sort jobs by match score', () => {
      const jobs = [
        { title: 'Low Score Job', company: 'Low Corp', location: 'London', match_score: 60 },
        { title: 'High Score Job', company: 'High Corp', location: 'London', match_score: 95 }
      ];
      const preferences = {
  ...
  describe('buildPersonalizedSubject - Variant C', () => {
    it('should create day-based variant with role and location', () => {
      const jobs = [
        { title: 'Full Stack Developer', company: 'Company A', location: 'Paris', match_score: 85 },
        { title: 'Backend Developer', company: 'Company B', location: 'Paris', match_score: 80 }
      ];
      const preferences = {
    ...
    it('should handle vowel-starting locations', () => {
      const jobs = [
        { title: 'Designer', company: 'Design Corp', location: 'Amsterdam', match_score: 90 }
      ];
      const preferences = {
    ...
    it('should handle consonant-starting locations', () => {
      const jobs = [
        { title: 'Engineer', company: 'Tech Corp', location: 'Berlin', match_score: 85 }
      ];
      const preferences = {
  ...
  describe('buildPersonalizedSubject - Edge Cases', () => {
    ...
    it('should handle jobs with missing company names', () => {
      const jobs = [
        { title: 'Developer', company: '', location: 'London', match_score: 85 },
        { title: 'Designer', company: undefined, location: 'London', match_score: 80 }
      ];
      const preferences = {
        rolePreference: 'Developer',
        locationPreference: 'London'
    ...
    it('should handle jobs with missing titles', () => {
      const jobs = [
        { title: '', company: 'Company A', location: 'London', match_score: 85 },
        { title: undefined, company: 'Company B', location: 'London', match_score: 80 }
      ];
      const preferences = {
        rolePreference: 'Developer',
        locationPreference: 'London'
    ...
    it('should handle custom date', () => {
      const jobs = [
        { title: 'Developer', company: 'Company A', location: 'London', match_score: 85 }
      ];
      const preferences = {
        rolePreference: 'Developer',
        locationPreference: 'London'
    ...
    it('should handle different day contexts', () => {
      ...
      const mondaySubject = buildPersonalizedSubject({ jobs, preferences, now: monday });
  ...
  describe('buildPersonalizedSubject - Role Preference Handling', () => {
    ...
    it('should handle mixed case role preferences', () => {
      const jobs = [
        { title: 'Engineer', company: 'Company A', location: 'London', match_score: 85 }
      ];
      const preferences = {
  ...
  describe('buildPersonalizedSubject - Company Selection', () => {
    it('should limit to top 3 companies', () => {
      const jobs = [
        { title: 'Job 1', company: 'Company A', location: 'London', match_score: 90 },
        { title: 'Job 2', company: 'Company B', location: 'London', match_score: 85 },
        { title: 'Job 3', company: 'Company C', location: 'London', match_score: 80 },
        { title: 'Job 4', company: 'Company D', location: 'London', match_score: 75 },
        { title: 'Job 5', company: 'Company E', location: 'London', match_score: 70 }
      ];
      const preferences = {
        rolePreference: 'Developer',
        locationPreference: 'London'
    ...
    it('should handle duplicate company names', () => {
      const jobs = [
        { title: 'Job 1', company: 'Company A', location: 'London', match_score: 90 },
        { title: 'Job 2', company: 'Company A', location: 'London', match_score: 85 },
        { title: 'Job 3', company: 'Company B', location: 'London', match_score: 80 }
      ];
      const preferences = {
        rolePreference: 'Developer',
        locationPreference: 'London'
