              ...
              message: {
                function_call: {
                  ...
                  arguments: JSON.stringify({
                    matches: [
                      { job_index: 1, job_hash: 'job1', match_score: 95, match_reason: 'Perfect fit' },
                      { job_index: 2, job_hash: 'job2', match_score: 90, match_reason: 'Great match' },
                      { job_index: 3, job_hash: 'job3', match_score: 85, match_reason: 'Good fit' },
                      { job_index: 4, job_hash: 'job4', match_score: 80, match_reason: 'Solid match' },
                      { job_index: 5, job_hash: 'job5', match_score: 75, match_reason: 'Decent fit' }
                    ]
                  })
                }
              }
