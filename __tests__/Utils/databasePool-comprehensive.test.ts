...
describe("Database Pool", () => {
	...
	describe("closeDatabasePool", () => {
		it("should close database pool", async () => {
			...
			// Get new client after close - should create new instance
			const client2 = getDatabaseClient();
			expect(client2).toBeDefined();
			// After close, getDatabaseClient should create a new instance
	...
	describe("Error Handling", () => {
		it.skip("should capture exceptions on initialization failure", async () => {
			// TODO: This test is difficult because the singleton pattern caches the instance
			// Need to properly reset the singleton state to test initialization failures
			await closeDatabasePool();
