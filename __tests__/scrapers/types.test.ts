...
describe('scrapers/types career path functions', () => {
  ...
  describe('extractCareerPathFromCategories', () => {
    it('should extract career path from categories string', () => {
      expect(extractCareerPathFromCategories('career:tech|loc:london')).toBe('tech');
      expect(extractCareerPathFromCategories('career:strategy')).toBe('strategy');
    });
    ...
    it('should return unknown for invalid career path', () => {
      expect(extractCareerPathFromCategories('career:invalid-path')).toBe('unknown');
    });
  ...
  describe('constants', () => {
    ...
    it('should have priority mapping', () => {
      expect(CAREER_PATH_PRIORITY['product']).toBeGreaterThan(CAREER_PATH_PRIORITY['tech']);
    });
  });
});
