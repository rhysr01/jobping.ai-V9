...
import type { EmailJobCard } from '@/Utils/email/types';
...
// User Matches API
export interface UserMatchesResponse extends SuccessResponse<{
  matches: JobMatch[];
  total: number;
  page: number;
  limit: number;
...
// Match Users API
export interface MatchUsersResponse extends SuccessResponse<{
...
// Email Feedback API
export interface EmailFeedbackResponse extends SuccessResponse<{
  feedbackId: string;
...
// Unsubscribe API
export interface UnsubscribeResponse extends SuccessResponse<{
  email: string;
...
// Admin Cleanup API
export interface CleanupJobsResponse extends SuccessResponse<{
  cleanupId: string;
  jobsDeleted: number;
...
// Dashboard API
export interface DashboardResponse extends SuccessResponse<{
  totalUsers: number;
  activeUsers: number;
  totalJobs: number;
  totalMatches: number;
...
// Metrics API
export interface MetricsResponse extends SuccessResponse<{
  current: {
    activeUsers: number;
    jobsScraped: number;
...
// Scrape API
export interface ScrapeResponse extends SuccessResponse<{
  platforms: string[];
  jobsScraped: number;
  processingTime: number;
  errors: string[];
